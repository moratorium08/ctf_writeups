// gcc execute.c -g -O0 -o execut -L/home/ubuntu/tsgctf/sqlpw/tsgctf -lsqlite3 -Wl,-rpath=/home/ubuntu/tsgctf/sqlpw/tsgctf && ./execut
...
int main()
{
  ...
  */
  ...
  memcpy(target, buf, 0x100 * sizeof(Op));
  struct DebugVdbe *vdbe = (struct DebugVbde *)stmt;
  vdbe->aOp = target;
  printf("%llx\n", (u64)(&vdbe->aOp) - (u64)vdbe);
